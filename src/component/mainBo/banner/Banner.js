  ...
  return (
    <div className={`container-fluid p-1 ban ${isOpen ? 'overlay' : ''}`}> 
      ...
      <div className="btm d-flex justify-content-between" style={{ width: '50%' }}>
            <Link to="/rudraksh">
              <button className='but1 mb-2 mt-3' style={{border:'1px solid #b16f23 ' ,borderBottom: '5px solid #b16f23' ,borderRadius: '10px',color:'#b16f23',backgroundColor: '#fefae0'}}>Buy Rudhraksh</button>
            </Link>

            <Link to="/gemstone">
              <button className='but2 mb-2 mt-3'style={{border:'1px solid #b16f23' ,borderBottom: '5px solid #b16f23',borderRadius: '10px' ,color:'#b16f23',backgroundColor: '#fefae0'}}>Buy Gemstone</button>
            </Link>
          </div>
    </div>
    </div> 
