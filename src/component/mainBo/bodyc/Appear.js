...
export default function Appear() {
  return (
    <div className="container mt-5 p-4" style={{ padding: '0', width: '100vw', maxWidth: '100%' }}>
  <div className="row justify-content-center">
    <div className="col-md-4 mb-4">
    <div className="card d-flex justify-content-center align-items-center" style={{ width: '300px', height: '350px', border: '1px solid #b16f23', color: '#b16f23' }}>
  ...
  <div className="row">
  <div className="col">
    <h2 style={{ color: '#b16f23' }}>Buy Spiritual Items Online at Radha Krishna Mart</h2>
    <p style={{ color: '#b16f23' }}>Radha Krishna Mart is an online store that offers a wide range of spiritual items for individuals who seek to enhance their spiritual practice. The store offers a variety of products, including Rudraksha Beads, Rings, Wall Hanging Yantra, Kada, Bracelet, Worship Idols, Horse Shoe, Kavach, Gemstones, Religious products, and spiritual gift items.<br/><br/>We specialize in authentic and high-quality products sourced from trusted vendors. Each item is designed to serve a specific spiritual purpose, and we provide a detailed description of each product to help customers make an informed purchase.<br/><br/>If you're looking to buy Rudraksha beads for your daily chanting practice or a Yantra wall hanging for your home altar, Radha Krishna Mart has a range of options to choose from. The store also offers spiritual jewelry, such as Kada and Bracelet, which are believed to have healing properties.</p>
  </div>
</div>
<div className="row">
  <div className="col">
